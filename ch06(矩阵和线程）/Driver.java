 ...
 * @author 赵惹儿
 *
 * @version创建时间：2018年11月12日下午6:59:47
 * @description: 驱动类Driver
 */
...
public class Driver {
	public final static int M=1000;  //定义常量：矩阵A的行数
	public final static int K=1000; //定义常量：矩阵A的列数，矩阵B的行数
	public final static int N=1000; //定义常量：矩阵B的列数
	final static int NUM_THREADS=4;//定义常量：线程数量
  ...
  //--------------------------------
		...
		System.out.println("计算["+M+","+K+"]与["+K+","+N+"]阶矩阵乘法,并行("+NUM_THREADS+"线程)用时:"+(time2-time1)+"ms");
 ...
 //---------------------------------
		...
		System.out.println("计算["+M+","+K+"]与["+K+","+N+"]阶矩阵乘法,直接计算用时:"+(time4-time3)+"ms");
		System.out.println(C[rol[0]][col[0]]+" "+C[rol[1]][col[1]]+" "+C[rol[2]][col[2]]);
		System.out.println();
 ...
 //------------------------------
		...
		//打印方法二使用的时间和矩阵C三个随机位置的值
		System.out.println("计算["+M+","+K+"]与["+K+","+N+"]阶矩阵乘法,线程池计算用时:"+(time6-time5)+"ms");
		System.out.println(C[rol[0]][col[0]]+" "+C[rol[1]][col[1]]+" "+C[rol[2]][col[2]]);
	}
